...
# Wallet Buttons
buy_button = dbc.Col(dbc.Button(id='buy', children=['Buy'], color="primary"))
sell_button = dbc.Col(dbc.Button(id='sell', children=['Sell'], color="primary"))
...
buy_submit = dbc.Button(id="buy_submit", children="Submit", color="primary")
...
coin_table = dbc.Table(coin_table_head + coin_table_rows, bordered=True, dark=True)

# Layout
row1 = dbc.Row(dbc.Col(wallet_head))
row2 = dbc.Row([dbc.Col(buy_button, width=1), dbc.Col(sell_button, width=1)], className="mb-4")
